...
<<<<<<< HEAD
        [SerializeField] private float m_TurnSpeed = 25; // How fast the rig will turn to keep up with target's rotation
        ...
        [SerializeField] private float m_SpinTurnLimit = 180;// The threshold beyond which the camera stops following the target's rotation. (used in situations where a car spins out, for example)
=======
